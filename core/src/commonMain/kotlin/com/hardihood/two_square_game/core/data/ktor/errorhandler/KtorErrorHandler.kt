    ...
    suspend fun handle(e: Any): Failure {
        when (e) {
            is ClientRequestException -> {
                ...
                try {
                    jsonObject = Json.decodeFromString(JsonObject.serializer(), bodyString)
                } catch (_: Exception) {
                ...
                return Failure(
                    ...
                    messages =
                    if (jsonObject?.containsKey("messages") == true) {
                        (jsonObject["messages"])!!.jsonArray[0].jsonPrimitive.content
